...
```go title="Histogram Cardinality Explosion" 3
...
```go title="Poorly chosen Histogram buckets" 3
...
```go title="Poorly chosen Histogram buckets" subtitle="client_go is your friend!" 3
...
```go title="Not initializing Metrics" subtitle="Let's define our reasons"
...
```go title="Not initializing Metrics" subtitle="And initialize it"
