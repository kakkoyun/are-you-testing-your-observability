...
import ss_tsdb_02 from './static/ss_tsdb_02.png'
import ss_tsdb_03 from './static/ss_tsdb_03.png'
import ss_tsdb_04 from './static/ss_tsdb_04.png'
import ss_tsdb_05 from './static/ss_tsdb_05.png'
...
TODO: Kemal - Screenshot
Metrics output with errors
...
prometheus.ExponentialBuckets(0.1, 1.5, 5),
prometheus.LinearBuckets(0.01, 0.01, 10)
...
<Image src={ss_tsdb_02} size='contain'/>
...
<Image src={ss_tsdb_03} size='contain'/>
...
<Image src={ss_tsdb_04} size='contain'/>
...
<Image src={ss_tsdb_05} size='contain'/>
...
```go title="Histogram vs Summary" subtitle="Do not forget to set your obsjectives!"
