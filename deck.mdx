...
```go 4,16,17,18,19,20,21,22,23,24,32,33 title="Pitfall #2: Consistency" subtitle="Red method satisfied"
...
<h2 style="text-align: center; margin: 0 10px 0 10px;">Pitfall #8: No Testing</h2>
...
And we will be shiaring our slides.
