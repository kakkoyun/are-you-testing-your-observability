...
```go 1[27:61],2[27:61],3[29:36],4[24:30]
	talks_total{title="   Are you testing your Observability?   "} 1
	talks_total{subtitle="      --- Metrics Edition ---      "} 1
	talks_total{conference="FOSDEM"} 1
	talks_total{where="Brussel"} 1
```
...
<div>
    <h1 style="text-align: center; margin: 0px 10px 0 10px;">
        <img src={prometheus} style="width: 20%; margin-top: 5%"/>
        &nbsp;&nbsp;Pitfalls
    </h1>
</div>
