...
func main() {
	...
	fmt.Println("    FOSDEM, 02.02.2020, Brussel    ")
}
```
...
import bartek from './static/gopher_bartek.png'
import kemal from './static/gopher_kemal.png'
import twitter from './static/twitter.png'
import github from './static/github.png'

<div style="width: 100%; height: 50%; overflow: auto;">
<img src={bartek} style="height: 90%; float: left;"/>
...
<div style="width: 100%; height: 50%; overflow: auto;">
<img src={kemal} style="height: 90%; float: left;"/>
...
import d04 from './static/d04.png'

<h2 style="text-align: center; margin: 0 10px 0 10px;">Wait... Anything missing?</h2>

<Image src={d04} size='contain'/>
...
import d07 from './static/d07.png'

<h2 style="text-align: center; margin: 0 10px 0 10px;">Wait... Anything missing?</h2>

<Image src={d07} size='contain'/>
...
```git title="Pitfall #4: Naming - Not conforming naming convention" subtitle="Names should have a suffix describing the unit"
...
```git title="Pitfall #4: Naming - Not conforming naming convention" subtitle="Counter names have *_total* as a suffix"
...
```git title="Pitfall #4: Naming - Not conforming naming convention" subtitle="_info suffix for metadata metric names"
...
```go title="Pitfall #5: Cardinality - Unbounded labels" subtitle="Define a metric" 7:14
...
```git title="Pitfall #6: Histogram Cardinality Explosion"
...
import itisfine from './static/itisfine.png'
