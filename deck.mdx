...
<CodeSurferColumns theme={shadesOfPurple}>
...
## Pitfalls #5: Not initializing Metrics
...
m.failures.WithLabelValues("unknown")
m.failures.WithLabelValues("no_target_available")
m.failures.WithLabelValues("timeout")
m.failures.WithLabelValues("no_target_resolved")
