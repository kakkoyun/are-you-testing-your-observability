...
```go title="Cardinality: Unbounded metrics" subtitle="Define a metric" 7:14
...
TODO: Clean up
	...
	This section helps you to pick and configure the appropriate metric type for your use case.

	Histograms and summaries both sample observations, typically request durations or response sizes.
...
TODO: Solution: SLO based! How to choose buckets?

Lets see some bad bucket layouts and how to fix them.

TODO: Flow
1) Match with subtitles
2)
3)
...
TODO: Add screenshots with graphs?
...
TODO: How to end? Check examples?
