...
<h2 style="text-align: center; margin: 0 10px 0 10px;">Pitfalls #3: Harcoding project name</h2>
...
<h2 style="text-align: center; margin: 0 10px 0 10px;">Pitfalls #5: Not initializing Metrics</h2>
...
<h2 style="text-align: center; margin: 0 10px 0 10px;">Pitfalls #6: Unbounded Cardinality</h2>
...
```go title="Unbounded Cardinality"
...
<h2 style="text-align: center; margin: 0 10px 0 10px;">Pitfalls #7: Poorly chosen Histogram buckects</h2>

---

<CodeSurfer>

```go title="Poorly chosen Histogram buckects"
```
